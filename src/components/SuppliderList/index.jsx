...
class SuppliderList extends PureComponent {
  constructor(props) {
    super(props);
...
SuppliderList.propTypes = {
  isLoading: PropTypes.bool.isRequired,
  data: PropTypes.array
};

SuppliderList.defaultProps = {
  isLoading: false,
  data: null
};

export default withStyles(styles, { withTheme: true })(SuppliderList);
